...
public class Player {
	...
	*/
	...
	public void moveUp(long delta){
		...
		// eixo y conta de cima para baixo
		double distance = delta * this.speed;
		double positionTop = this.cy - (this.height / 2);

		this.cy = positionTop - distance > v_limit[0] ? this.cy - distance : this.v_limit[0] + (this.height / 2);
	}
	...
	*/
	...
	public void moveDown(long delta){
		...
		// eixo y conta de cima para baixo
		double distance = delta * this.speed;
		double positionBottom = this.cy + (this.height / 2);

		this.cy = positionBottom + distance < v_limit[1] ? this.cy + distance : this.v_limit[1] - (this.height / 2);
	}
